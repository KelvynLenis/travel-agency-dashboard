...
const TripDetail = ({ loaderData }: Route.ComponentProps) => {
  ...
  const visitTimeAndWeattherInfo = [
  ...
  return (
    <main className="travel-detail wrapper">
      <Header
        title="Trip Details"
        description="View and edit AI-generated travle plans"
      />
      ...
      <section className="container wrapper-md">
          ...
          {imageUrls.map((url: string, i: number) => (
            <img
              ...
              className={cn(
                ...
                i === 0
                  ? "md:cols-span-2 md:row-span-2 h-[330ox]"
        ...
        <ul className="itinerary">
          {itinerary?.map((dayPlan: DayPlan, index: number) => (
            <li key={index}>
              ...
              <ul>
                {dayPlan.activities.map((activity: Activity, i: number) => (
                  <li key={index}>
        ...
        {visitTimeAndWeattherInfo.map((section) => (
